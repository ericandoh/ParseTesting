...
let USER_TITLE_TEXT_FONT = UIFont(name: "Didot-HTF-B24-Bold-Ital", size: 20.0)!;
...
//let MIN_SHOPLOOK_DESCRIP_CONSTRAINT = CGFloat(143.0);
let MIN_SHOPLOOK_DESCRIP_CONSTRAINT = ceil(MIN_DESCRIP_TOTAL_SPACE / 2.0);
let MIN_SHOPLOOK_TOTAL_FLEXIBLE_CONSTRAINT = TRUE_FULLSCREEN_HEIGHT - 115.0 - 45.0 - 40.0 - 5.0 - 60.0 - MIN_SHOPLOOK_CONSTRAINT;
//----end home descrip-----
...
let BOX_START_Y = CGFloat(351.0);                //starting y pos of shop look boxes
...
let SCROLLFIELD_DEFAULT_HEIGHT = CGFloat(536.0); //height of scrollfield when no shoplooks
//----end shop the look------
